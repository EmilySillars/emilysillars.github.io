...
* Description: This is the pure javascsript for my website. It adds a "rain button" to my homepage.
*   When this button is clicked, purple rain drops appear to fall in front of the page in an endless loop.
*   The design of the rain button is meant to emulate a switch. When the handel/slider is on the left,
*   the rain button is OFF. When the handel/slider is on the right, the rain button is ON.
*   Clicking on the handel moves the handel left/right OFF/ON according to its current state.
* Note: Additional functionality for my tomato fake ad button is added using jQuery in my jquery.js file.
*****/
